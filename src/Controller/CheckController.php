...
#[Route('/check')]
class
CheckController extends AbstractController
{
    ...
    {
        $check = new Check();
        $this->denyAccessUnlessGranted('new', $check);
    ...
    {
        $this->denyAccessUnlessGranted('show', $check);
    ...
    {
        $this->denyAccessUnlessGranted('edit', $check);
        $form = $this->createForm(CheckType::class, $check);
        $form->handleRequest($request);
    ...
    {
        $this->denyAccessUnlessGranted('delete', $check);
